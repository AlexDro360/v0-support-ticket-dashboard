...
export interface EquipoBasicoEliminar {
  id: string
...
interface ConfirmarEliminarEquipoDialogProps {
  open: boolean
  equipo: EquipoBasicoEliminar | null
  isLoading?: boolean
  onConfirm: () => void | Promise<void>
  onOpenChange: (open: boolean) => void
}

function DetallesEquipo({ equipo }: { equipo: EquipoBasicoEliminar }) {
  return (
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Esta acción eliminará permanentemente el equipo de la base de datos. No podrá ser recuperado.
              </p>
            </div>
